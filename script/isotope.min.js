...
ID.modules["fizzy-bear-shirt"]=function(e){"use strict";var t=new Date(2021,5,9),r=Math.round((t-new Date)/864e5);e.querySelector(".fizzy-bear-shirt__title").textContent="Rainbow bear shirts. Only on sale for "+r+" more days."};
...
ID.modules["refactor-shirt"]=function(t){"use strict";var e=new Date(2021,1,10),r=Math.round((e-new Date)/864e5);t.querySelector(".refactor-shirt__title").textContent="Refactor shirts. Only on sale for "+r+" more days."};
